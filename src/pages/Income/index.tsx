...
export default () => {
  ...
  return (
    <div className={styles.content}>
      <p>Total HashRate: {poolInfo?.total} T</p>
      <p>
        Total Mining Pool Revenue: {mbitcoinInfo?.tokenAmount.uiAmount} mBTC
      </p>

      <p>Hold HashRate: {myAccountInfo.tokenAmount.uiAmount} T</p>
      <p>
        Account Income:
